...
class MainViewController: UIViewController,UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if !searchActive
        {
            ...
            let url = URL(string: cellArrayGetIndex.getIconViewUrl() as! String)
            ...
            cell.shortening.text = "(" + cellArrayGetIndex.getShortening().uppercased() + ")"
            return cell
        }
        else
        {
            ...
            let url = URL(string: cellSearchArrayGetIndex.getImageUrl() as! String)
    ...
    func getSearchArray()
    {
        for n in 1...28
        {
            coinGecko.getCoinMarkets(vs_currency: "usd", order: "market_cap_desc", per_page: 250, page: n, sparkline: false,index: n) {(result) in
    ...
    {
        coinGecko.getCoins(vs_currency: "usd", order: "market_cap_desc", per_page: 100, page: page, sparkline: false, index: 0) { (result) in
